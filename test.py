...
from model.PLV_CSNet import PLV_CSNet
...
model = PLV_CSNet(opt.block_size, opt.sub_rate)
...
with torch.no_grad():
    for index, image_name in enumerate(image_list):
        ...
        im_x_0 = numpy_to_img(x_0.cpu().data[0].numpy().astype(np.float32))
